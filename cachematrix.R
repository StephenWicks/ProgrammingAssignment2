...
##This extra function will evaluate if two matricies are identical.
...
## The returned value will be calculated if the matrix is not cached, and will be retrieved
## from a cache if it is stored in one.
